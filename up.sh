...
echo "========================================"
echo ""
echo "  Soofi UI:      http://localhost:${SOOFI_UI_PORT:-3001}"
echo "  Open WebUI:    http://localhost:${OPENWEBUI_PORT:-3000}"
echo "  MCP Inspector: http://localhost:${MCPINSPECTOR_CLIENT_PORT:-6274}/?transport=streamable-http&serverUrl=http://vector-mcp:8000/mcp/&MCP_PROXY_AUTH_TOKEN=${MCP_AUTH_TOKEN:-dev-stack-token-12345}"
echo "  Weaviate:      http://localhost:${WEAVIATE_PORT:-8070}"
echo "  N8N:           http://localhost:${N8N_EXTERNAL_PORT:-5678} (admin@example.com / S8fi-password)"
echo ""
echo "========================================"
echo ""
